document.getElementById('searchForm').onsubmit = function(event) {
  ...
  if(text && area) {
    var url = `http://yourhost.example/api/scraper/hh/vacancies?text=${text}&area=${area}`;
  } if(text) {
    var url = `http://yourhost.example/api/scraper/hh/vacancies?text=${text}`;
  } if(area) {
    var url = `http://yourhost.example/api/scraper/hh/vacancies?area=${area}`;
  }else {
    var url = 'http://yourhost.example/api/scraper/hh/vacancies'
  }
